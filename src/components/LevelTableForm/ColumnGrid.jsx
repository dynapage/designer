  ...
  const dropColumn = async () => {
    try {
      ...
      if (deleteTableConfirmationCounter < 2) {
        const status = await columnApi.checkColumnName(
          selectedApp._id,
          selectedRow.shapevalue
        )
        ...
        if (status.status == false) {
          const res = await columnApi.delete(
            selectedApp._id,
            selectedTable._id,
            selectedRow._id
          )
      ...
      >
        ...
        {showExistField ? (
          <Box sx={{ color: "red", backgroundColor: "white" }}>
            <h4>
              Field: {selectedRow.shapevalue} already used in a form, can not be
              deleted
            </h4>
          </Box>
        ) : null}
        ...
        {openNewAppDrawer ? (
          <ColumnForm
            ...
            openNewAppDrawer={openNewAppDrawer}
            setOpenNewAppDrawer={setOpenNewAppDrawer}
          ></ColumnForm>
        ) : null}
