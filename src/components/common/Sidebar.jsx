...
import { Box, Drawer, IconButton, List, Button, ListItem, ListItemButton, Typography } from '@mui/material'
    ...
    ><br /><br />
      <List
        ...
        sx={{
          width: sidebarWidth,
          height: '100vh',
          backgroundColor: themeMode == "light" ? assets.colors.secondary : assets.colors.primaryDark
        }}
      ><br />
        <ListItem>
          <Box sx={{
      ...
      <Button onClick={changeTheme}>{userTheme === "dark" ? 'Light theme' : 'Dark theme'} </Button>
